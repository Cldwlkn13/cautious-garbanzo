...
{
    public class PaddyPowerSportsbookHandler : IPaddyPowerSportsbookHandler
    {
        private readonly IOptions<SportsbookSettings> _options;
        private readonly IAuthHandler _authHandler;
        private ISportsbookClient? _client;

        private const Bookmaker _bookmaker = Bookmaker.PaddyPower;

        public PaddyPowerSportsbookHandler(IOptions<SportsbookSettings> options, IAuthHandler authHandler)
        {
        ...
        {
            throw new NotImplementedException($"PaddyPowerSportsbookHandler : ListEventTypes");
        ...
        {
            throw new NotImplementedException($"PaddyPowerSportsbookHandler : ListCompetitions");
        ...
        public IEnumerable<Event> ListEventsByEventType(
            string eventTypeId = "7", TimeRange? timeRange = null)
        {
            throw new NotImplementedException($"PaddyPowerSportsbookHandler : ListEventsByEventType");
        ...
        {
            throw new NotImplementedException($"PaddyPowerSportsbookHandler : ListEventsByCompetition");
        ...
        {
            throw new NotImplementedException($"PaddyPowerSportsbookHandler : ListMarketTypes");
        ...
        {
            throw new NotImplementedException($"PaddyPowerSportsbookHandler : ListMarketCatalogues");
        ...
        {
            throw new NotImplementedException($"PaddyPowerSportsbookHandler : ListPrices");
